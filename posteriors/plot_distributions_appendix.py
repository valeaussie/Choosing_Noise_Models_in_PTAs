...
bins = np.logspace(np.log10(min_bin), np.log10(max_bin), nbin)

# Plot
plt.figure(figsize=(10, 6))
plt.hist(distances_1, bins=bins, alpha=0.6, edgecolor='#d3d3d3', density=False, label='Misspecified', color='steelblue')
plt.hist(distances_2, bins=bins, alpha=0.6, edgecolor='#d3d3d3', density=False, label='Correctly specified', color='darkorange')
