...
def red_noise_block(psd='powerlaw', prior='log-uniform', Tspan=None,
    ...
    """
    AZ MODIFIED TO TAKE RHOMIN RHOMAX PRIORS AS KWARG FOR FREE-SPECTRUM ANALYSIS
...
def common_red_noise_block(psd='powerlaw', prior='log-uniform',
    ...
    """
    AZ MODIFIED TO TAKE `SELECT` AS A KWARG
    FOR E.G. DOING MULTIPLE CRN TERMS IN TIME-SLICES TO ASSESS 
    STATIONARITY
